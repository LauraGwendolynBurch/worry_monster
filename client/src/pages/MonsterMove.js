...
// import ButtonMove from "./button.jsx";
...
export class MonsterMove {
  ...
  y: 180,//down
    ...
    updateAnimation: function()
    {
        ...
        (
            image,
            this.monster.sourceX, this.monster.sourceY, this.monster.SIZE, this.monster.SIZE,
            Math.floor(this.monster.x), Math.floor(this.monster.y), this.monster.SIZE, this.monster.SIZE
        );
